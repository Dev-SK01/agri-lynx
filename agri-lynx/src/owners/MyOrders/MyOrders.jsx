...
const commodities = [
  { commodity: "Tomato", quantity: "10KG",   location: "Madurai", name: "Rishikesavan", phoneNumber: "+91 9874563210",status:"Ordered"},
  { commodity: "Brinjal", quantity: "11KG", location: "Ramnad", name: "Rishikesavan", phoneNumber: "+91 9874563210" ,status:"Shipped"},
  { commodity: "Potato", quantity: "100KG",  location: "Sivagangai", name: "Rishikesavan", phoneNumber: "+91 9874563210",status:"Delivered"},
  { commodity: "Carrot", quantity: "10KG",   location: "Madurai", name: "Rishikesavan", phoneNumber: "+91 9874563210",status:"Packed"},
  { commodity: "Beetroot", quantity: "11KG", location: "Ramnad", name: "Rishikesavan", phoneNumber: "+91 9874563210",status:"Canceled"},
  { commodity: "GroundNut", quantity: "100KG",  location: "Sivagangai", name: "Rishikesavan", phoneNumber: "+91 9874563210",status:"Ordered"},
  { commodity: "Maize", quantity: "10KG",   location: "Madurai", name: "Rishikesavan", phoneNumber: "+91 9874563210" ,status:"Shipped"},
  { commodity: "Corn", quantity: "11KG", location: "Ramnad", name: "Rishikesavan", phoneNumber: "+91 9874563210" ,status:"Delivered"},
  { commodity: "Bitterguard", quantity: "100KG",  location: "Sivagangai", name: "Rishikesavan", phoneNumber: "+91 9874563210",status:"Canceled"},
  { commodity: "Tomato", quantity: "10KG",   location: "Madurai", name: "Rishikesavan", phoneNumber: "+91 9874563210" ,status:"Packed"},
  { commodity: "Brinjal", quantity: "11KG", location: "Ramnad", name: "Rishikesavan", phoneNumber: "+91 9874563210",status:"Shipped"},
  { commodity: "Potato", quantity: "100KG",  location: "Sivagangai", name: "Rishikesavan", phoneNumber: "+91 9874563210" ,status:"Ordered"},
  { commodity: "Carrot", quantity: "10KG",   location: "Madurai", name: "Rishikesavan", phoneNumber: "+91 9874563210",status:"Ordered"},
  { commodity: "Beetroot", quantity: "11KG", location: "Ramnad", name: "Rishikesavan", phoneNumber: "+91 9874563210" ,status:"Ordered"},
  { commodity: "GroundNut", quantity: "100KG",  location: "Sivagangai", name: "Rishikesavan", phoneNumber: "+91 9874563210",status:"Ordered"},
  { commodity: "Maize", quantity: "10KG",   location: "Madurai", name: "Rishikesavan", phoneNumber: "+91 9874563210",status:"Delivered"},
  { commodity: "Corn", quantity: "11KG", location: "Ramnad", name: "Rishikesavan", phoneNumber: "+91 9874563210" ,status:"Delivered"},
   { commodity: "Bitterguard", quantity: "100KG",  location: "Sivagangai", name: "Rishikesavan", phoneNumber: "+91 9874563210",status:"Delivered"}
    ...
    <div className="flex items-center justify-center flex-col">
         {/* Header */}
                    ...
                    <button key={status}onClick={() => setSelectedStatus(status)}
                     className={` rounded-xl h-6 px-4  font-medium font-inter ${selectedStatus === status ? " text-balck bg-(primary) border-1 border-green-500" : "bg-[var(--primary)]"}`}>
                    {status}
                    </button>
                    ))}
                   </div></div>
                    ...
                    {commodities.filter((item) => item.status === selectedStatus).map((item, index) => (
