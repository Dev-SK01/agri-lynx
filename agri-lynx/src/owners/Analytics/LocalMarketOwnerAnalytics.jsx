    ...
    <>
      ...
      <nav className="flex items-center justify-center flex-col mt-7">
        <div>
          ...
          <img
            className="inline-block -mt-2 ml-1.5"
            src={analytics}
            alt="Assests"
          />
        </div>
      ...
      <a
        href="https://www.agmarknet.gov.in"
        target="_blank"
        rel="noopener noreferrer"
      >
        <div className="bg-(--green) text-xl mt-5 ml-5  border-2 border-black p-1 px- py-1 rounded-lg w-[50%]">
